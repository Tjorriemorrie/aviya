...
class Model_Image
{
	...
	public function setWatermark($watermark, $newsletter)
	{
		...
		$dst_path = APPLICATION_PATH . '/data/tmp/tmp.jpg';
		if (imagejpeg($dst, $dst_path)) return $dst_path;
		else {echo "could not save newsletter"; exit;}
	}
	
	
	public function setTextmark($image_path, $text)
	{
